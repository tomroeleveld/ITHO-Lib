...
const uint8_t ithoMessage2MediumCommandBytes[] = {6,89,150,170,149,165,90,150,105,169,101,89,150,85,169}; //{6,89,150,170,165,101,90,150,85,149,101,90,150,85,150};
