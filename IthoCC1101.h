...
const uint8_t ithoMessage2MediumCommandBytes[] = {6,89,150,170,169,101,90,102,85,149,101,89,150,165,150}; //{6,89,150,170,165,101,90,150,85,149,101,90,150,85,150};
